...
plt.plot(X['CustomerAge'],X['TransactionAmount'],'ko-',markerfacecolor='green',linewidth=0.7)
plt.xlabel('Age')
plt.ylabel('Trnt. Amt.')
plt.show()

# sns.scatterplot(x='CustomerAge',y='TransactionAmount',data=X,hue='CustomerGender',palette='pastel')
# plt.xlabel('Age')
# plt.ylabel('Trnt. Amt.')
# plt.show()
